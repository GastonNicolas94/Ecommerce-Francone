                    ...
                    <div className="container text-center text-md-left">
                        <div className="row text-center text-md-left">
                            <div className="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
                                <h5 className="text-uppercase mb-4 font-weight-bold text-dark">GNF</h5>
                            </div>
                            <div className="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
                                <h5 className="text-uppercase mb-4 font-weight-bold text-dark">Productos</h5>
                                <p>
                                    <Link className="text-decoration-none text-dark" to='/category/REMERAS'>Remeras</Link>
                                </p>
                                <p>
                                    <Link className="text-decoration-none text-dark" to='/category/CALZAS'>Calzas</Link>
                                </p>
                                <p>
                                    <Link className="text-decoration-none text-dark" to='/category/GUANTES'>Guantes</Link>
                                </p>
                                <p>
                                    <Link className="text-decoration-none text-dark" to='/category/SHORTS'>Shorts</Link>
                                </p>
                            </div>
                            ...
                            <div className="row mt-4">
                                <div className="col-md-12 col-lg-12 text-dark">
                                    <p>Copyright @2022 - Todos los derechos reservados - GNF</p>
                                </div>
                            </div>
                        </div>
                    </div>
